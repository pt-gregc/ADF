	...
	<tbody id="childElementInputs" <cfif NOT IsNumeric(joinObj)>style="display:none;"</cfif>>
		...
		<tr>
			...
			<td valign="baseline" class="cs_dlgLabelSmall">
				...
				<span id="newOptionTextSpan" <cfif NOT ListFindNoCase(currentValues.interfaceOptions,'new')>style="display:none;"</cfif>>Button Text:&nbsp;#Server.CommonSpot.udf.tag.input(type="text", id="#prefix#newOptionText", name="#prefix#newOptionText", value="#currentValues.newOptionText#", size="30", class="InputControl")#</span><br/></span>
				...
				<span id="existingOptionTextSpan" <cfif NOT ListFindNoCase(currentValues.interfaceOptions,'existing')>style="display:none;"</cfif>>Button Text:&nbsp;#Server.CommonSpot.udf.tag.input(type="text", id="#prefix#existingOptionText", name="#prefix#existingOptionText", value="#currentValues.existingOptionText#", size="30", class="InputControl")#</span><br/></span>
				...
				<span id="editChildOptionTextSpan" <cfif NOT ListFindNoCase(currentValues.interfaceOptions,'editChild')>style="display:none;"</cfif>>Hover Text:&nbsp;#Server.CommonSpot.udf.tag.input(type="text", id="#prefix#editChildOptionText", name="#prefix#editChildOptionText", value="#currentValues.editChildOptionText#", size="30", class="InputControl")#</span><br/></span>
				...
				<span id="deleteOptionTextSpan" <cfif NOT ListFindNoCase(currentValues.interfaceOptions,'delete')>style="display:none;"</cfif>>Hover Text:&nbsp;#Server.CommonSpot.udf.tag.input(type="text", id="#prefix#deleteOptionText", name="#prefix#deleteOptionText", value="#currentValues.deleteOptionText#", size="30", class="InputControl")#</span>
			</td>
		</tr>
		<tr>
