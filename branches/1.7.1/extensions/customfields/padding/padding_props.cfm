	...
	<table>
		<tr>
			...
			<td class="cs_dlgLabelSmall">
				...
				<br>If Possible Values are specified, then the user is presented with a selection list of the possible values. Otherwise an input control will be presented.
			</td>
		</tr>
