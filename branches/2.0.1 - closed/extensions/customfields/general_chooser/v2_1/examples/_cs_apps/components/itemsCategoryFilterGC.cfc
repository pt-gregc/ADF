...
History:
	...
	2016-12-06 - GAC - Based on the 2.0 itemsCategoryFilterGC but updated for General Chooser 2.1
--->
...
<cffunction name="loadSearchBox" access="public" returntype="string" hint="General Chooser - Search box HTML content.">
	...
	<cfscript>
		...
		var cftGeneralChooserSearchBoxCSS = "";
		var cftGeneralChooserSearchBoxJS = "";
	...
	<cfif variables.SHOW_SEARCH EQ true AND !arguments.readonly>
		...
		<cfsavecontent variable="cftGeneralChooserSearchBoxCSS">
		...
		<cfsavecontent variable="cftGeneralChooserSearchBoxJS">
			<cfoutput>
		...
		<cfscript>
			application.ADF.scripts.addHeaderCSS(cftGeneralChooserSearchBoxCSS,"TERTIARY"); // Load after main GC CSS
			application.ADF.scripts.addFooterJS(cftGeneralChooserSearchBoxJS,"TERTIARY");   // Load after main GC JS
		</cfscript>
	</cfif>
...
<cffunction name="loadAddNewLink" access="public" returntype="string" hint="General Chooser - Add New Link HTML content.">
	...
	<cfscript>
		var retAddLinkHTML = "";
		var cftGeneralChooserAddLinkJS = "";
		var ceFormID = 0;
	...
	<cfif variables.SHOW_ADD_LINK EQ true AND !arguments.readonly>
		...
		<!--- // Build teh JS for the show all link to the field type --->
		<cfsavecontent variable="cftGeneralChooserAddLinkJS">
			<cfoutput>
		...
		<cfscript>
			application.ADF.scripts.addFooterJS(cftGeneralChooserAddLinkJS,"TERTIARY"); // Load after main GC JS
		</cfscript>
...
<!--- **************************************************** --->
<!--- ** START - _renderChooserJS Subfunction Overrides ** --->
<!--- **************************************************** --->

<!---
	_renderChooserJS_globalVars - Custom Override
--->
...
<!---
	_renderChooserJS_docReady - Custom Override
--->
...
<!---
	_renderChooserJS_chooserItems - Custom Override
--->
...
<!--- ************************************************** --->
<!--- ** END - _renderChooserJS Subfunction Overrides ** --->
<!--- ************************************************** --->
