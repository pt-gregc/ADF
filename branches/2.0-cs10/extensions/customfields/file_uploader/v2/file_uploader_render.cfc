...
<cffunction name="renderControl" returntype="void" access="public">
	...
	<cfscript>
		...
		var imageURL = "/ADF/extensions/customfields/file_uploader/v2/handleFileDownload.cfm?subsiteURL=#request.subsite.url#&fieldID=#arguments.fieldID#&filename=";
		var concatenator = "";
	...
	<cfoutput>
		<div>
			...
			<div id="uploadHolder_#arguments.fieldName#" style="min-width:475px">
				<iframe height="70px" width="375px" scrolling="no" frameBorder="0" src="/ADF/extensions/customfields/file_uploader/v2/fileUploadForm.cfm?subsiteURL=#request.subsite.url#&fieldName=#arguments.fieldName#&uploadUUID=#uploadUUID#&inputID=#arguments.fieldID#"></iframe>
			</div>
