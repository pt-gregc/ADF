...
--->
<cfcomponent displayname="csContent_1_0" extends="ADF.lib.libraryBase" hint="Constructs a CCAPI instance and then allows you to populate Custom Elements and Textblocks">
