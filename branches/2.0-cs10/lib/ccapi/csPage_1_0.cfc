...
---> 
<cfcomponent displayname="csPage_1_0" extends="ADF.lib.libraryBase" hint="Constructs a CCAPI instance and then creates or deletes a page with the given information">
