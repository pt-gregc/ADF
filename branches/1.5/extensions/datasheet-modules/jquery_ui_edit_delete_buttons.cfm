...
Author: 	
	...
	M. Carroll
Name:
	jquery_ui_edit_delete_buttons.cfm
Summary:
	Renders JQuery UI styled Edit and Delete buttons for the datasheet.
	The button clicks use the sites edit and delete form files:
		"/datasheet-modules/edit-form-data.cfm"
		"/datasheet-modules/delete-form-data.cfm"
	This is an alternative to adding action columns into the datasheet.
ADF Lib Requirements:
	Scripts
History:
	2010-09-27 - MFC - Created
--->
