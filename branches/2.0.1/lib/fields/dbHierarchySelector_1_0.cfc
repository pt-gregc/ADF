...
Name:
	dbHierarchySelector_1_0.cfc
Summary:
	This is a pass-through for the base component for the Custom Element Hierarchy Selector field
ADF Requirements:
	
History:
	2016-08-03 - GAC - Created
--->
<cfcomponent displayname="dbtHierarchySelector_1_0" extends="ADF.extensions.customfields.db_hierarchy_selector.db_hierarchy_selector_base" output="false"  hint="This is the base component for the DB Hierarchy Selector field">

<cfproperty name="version" value="1_0_0">
<cfproperty name="type" value="transient">
<cfproperty name="wikiTitle" value="dbHierarchySelector_1_0">
