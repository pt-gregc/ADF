...
<cfscript>
	...
	// Get the formid
	linkDataFormID = application.ADF.ceData.getFormIDByCEName("Link Builder Data");
</cfscript>
...
<cfoutput>
	...
	<tr>
		...
		<td class="cs_dlgLabelSmall">
			<cfinclude template="/ADF/extensions/customfields/link_builder/link_builder_js.cfm">
			<cfscript>
			...
			<a href="javascript:;" class="addLink_#fqFieldName#" onclick="addLink_#fqFieldName#();">Add New Link</a>
